...
When the two categorical variables _have exactly 2 categories each_, and thus yield a 2 x 2 contingency table, the **Fisher's Exact test** (a type of contingency test) provides an EXACT _P_-value, and is therefore preferred over the $\chi$^2^ contingency test (below) when you have a computer to do the calculations.  
