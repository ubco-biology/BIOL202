...
It has also benefited from valuable feedback from the many BIOL202 teaching assistants who have helped me over the year.  Thank you!
...
* The `n` in the last line actually a function that tallies the sample size or count of all observations in the present category or group, and then the `sum(n)` sums up the total sample size. Thus, `n / sum(n)` calculates the relative frequency (equivalent to the <a href="https://ubco-biology.github.io/Procedures-and-Guidelines/glossary#Proportion">proportion</a>) of all observations that are within the given category
...
<!--chapter:end:09_single_categorical_variable.Rmd-->
...
<!--chapter:end:10_two_categorical_variables.Rmd-->
...
<!--chapter:end:11_single_numeric_variable.Rmd-->
...
<!--chapter:end:12_comparing_two_means.Rmd-->
...
<!--chapter:end:13_Comparing_more_than_2_means.Rmd-->
...
<!--chapter:end:14_Correlation.Rmd-->
...
<!--chapter:end:97_assumptions_transformations.Rmd-->
