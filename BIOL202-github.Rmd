...
```{r}
kable(tiger.table, caption = "Frequency table showing the activities of 88 people at the time they were attached and killed by tigers near Chitwan national Park, Nepal, from 1979 to 2006", digits = 3)
```
...
```{r bargraph, fig.cap = "Bar graph showing the activities of 88 people at the time they were attached and killed by tigers near Chitwan national Park, Nepal, from 1979 to 2006", fig.width = 4, fig.height = 6}
...
```{r hist_penguins, fig.cap = "Histogram of body mass (g) for 342 penguins", fig.width = 4, warning = FALSE}
...
Voila! Your first ggplot histogram! But wait, you also need to be able to describe what you see...
...
<!--chapter:end:04_describe_visualize_single_variable.Rmd-->
