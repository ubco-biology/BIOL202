...
**NOTE**: Some users might get an error when attempting this; if this happens, consult the [Common errors and their solutions](https://ubco-biology.github.io/BIOL202/common-errors-and-their-solutions.html) tutorial webpage, which includes an entry on this mosaic plot issue).  If you get some "warnings", don't worry about those, as they won't interfere with getting a proper plot.  
...
As instructed in the [checking assumptions](#checknorm_assum) tutorial, we should use a normal quantile plot to visually check the normal distribution assumption, using the calculated differences.
...
<!--chapter:end:17_Least_squares_regression.Rmd-->
...
<!--chapter:end:94_load_all_packages.Rmd-->
...
When attempting to create a mosaic plot (e.g. section xx) using `ggplot2` and `ggmosaic` packages, this error arises:
