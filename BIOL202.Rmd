...
**NOTE**: Some users might get an error when attempting this; if this happens, consult the relevant section of the [Common errors and their solutions page](https://ubco-biology.github.io/BIOL202/error-creating-mosaic-plot.html) tutorial webpage, which includes an entry on this mosaic plot issue).  If you get some "warnings", don't worry about those, as they won't interfere with getting a proper plot.  
