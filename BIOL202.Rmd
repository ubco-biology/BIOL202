...
Here's the code, and we'll explain after (**NOTE**: some users might get an error and/or warning messages; if this happens, use the alternative code provided further down):
...
This code also avoids a conflict with the `xlab` and `ylab` functions.
