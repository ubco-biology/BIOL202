...
```{r vis1_bargraph, fig.cap = "Bar graph showing the activities of 88 people at the time they were attached and killed by tigers near Chitwan national Park, Nepal, from 1979 to 2006", fig.width = 6, fig.height = 6}
...
```{r vis1_hist_penguins, fig.cap = "Histogram of body mass (g) for 342 penguins", fig.width = 4, warning = FALSE}
...
```{r vis1_hist_penguins1, fig.cap = "Histogram of body mass (g) for 342 penguins", fig.width = 4, warning = FALSE}
ggplot(data = penguins, aes(x = body_mass_g)) +
...
```{r vis1_hist_penguins2, fig.cap = "Histogram of body mass (g) for 342 penguins", fig.width = 4, warning = FALSE}
ggplot(data = penguins, aes(x = body_mass_g)) +
...
```{r vis1_hist_penguins3, fig.cap = "Histogram of body mass (g) for 342 penguins", fig.width = 4, warning = FALSE}
ggplot(data = penguins, aes(x = body_mass_g)) +
  geom_histogram(binwidth = 250, colour = "black", fill = "lightgrey") +
  xlab("Body mass (g)") +
  ylab("Frequency") +
