...
For an example of an HTML (webpage) document that illustrates literate programming, download [this HTML file](https://osf.io/h7p6a) and open it in your browser.  It accompanied a lab-based experiment examining the potential for freshwater diatoms to be successfully dispersed over long distances adhered to duck feathers.
