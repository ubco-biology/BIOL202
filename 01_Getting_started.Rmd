...
<div class="note">
Ath the time of writing this module, the latest version of R was 4.2.1 ("Funny-looking-kid") (2022-06-23).  At the beginning of term, it is recommended that you update to the latest version of R, but once you've started into the tutorials, it is recommended that you NOT update again until after term is complete. This is to avoid any unforeseen problems introduced by the update.  **However** If you have an older operating system on your computer, you'll want to check compatibility of both R and RStudio.  With respect to RStudio, its website (rstudio.com) should detect your operating system and provide the appropriate download option automatically.  The website with older versions of R is [here](https://cran.r-project.org/bin/macosx/), and older versions of RStudio is [here](https://www.rstudio.com/products/rstudio/older-versions/).  
</div>
