...
\textbf{NOTE}: Some users might get an error when attempting this; if this happens, consult the \href{https://ubco-biology.github.io/BIOL202/common-errors-and-their-solutions.html}{Common errors and their solutions} tutorial webpage, which includes an entry on this mosaic plot issue). If you get some ``warnings'', don't worry about those, as they won't interfere with getting a proper plot.
...
When attempting to create a mosaic plot (e.g.~section xx) using \texttt{ggplot2} and \texttt{ggmosaic} packages, this error arises:
