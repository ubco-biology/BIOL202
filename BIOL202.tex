...
As instructed in the \protect\hyperlink{checknorm_assum}{checking assumptions} tutorial, we should use a normal quantile plot to visually check the normal distribution assumption, using the calculated differences.
