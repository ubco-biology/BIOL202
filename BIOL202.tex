...
Here's the code, and we'll explain after (\textbf{NOTE}: some users might get an error and/or warning messages; if this happens, use the alternative code provided further down):
