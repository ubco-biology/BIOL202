...
\pandocbounded{\includegraphics[keepaspectratio]{./more/creative-commons-783531_1280.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/RStudio_Window.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/cheatsheets.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7808}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2192}}@{}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/BIOL202_directory_structure.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/assign_header.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/install_package_header2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/figure_chunk_header.png}}

\pandocbounded{\includegraphics[keepaspectratio]{./more/example_histogram_practice.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/excel_tidy.png}}
\caption{\label{fig:exceltidy}Tidy data in Excel}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/files_pane_rawdata.png}}
\caption{\label{fig:unnamed-chunk-19}View of files with rawdata folder}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-27-1.pdf}}
\caption{\label{fig:unnamed-chunk-27}Bar graph showing the activities of 88 people at the time they were attached and killed by tigers near Chitwan national Park, Nepal, from 1979 to 2006}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/bar_graph_chunk.png}}
\caption{\label{fig:unnamed-chunk-28}Example code chunk for producing a good bar graph}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-29-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-30-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-31-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-33-1.pdf}}
\caption{\label{fig:unnamed-chunk-33}Histogram of body mass (g) for 342 penguins}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/na_error.png}}
\caption{\label{fig:unnamed-chunk-34}Error when functions encounter `NA' values}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/malaria_barchart1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/grouped_bar_graph.png}}
\caption{\label{fig:unnamed-chunk-41}Example code chunk for producing a good grouped bar graph}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-42-1.pdf}}
\caption{\label{fig:unnamed-chunk-42}Grouped bar graph showing the incidence of malaria in female great tits in relation to control (N = 35) and Egg-removal (N = 30) treatment groups.}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/mosaic_malaria1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-43-1.pdf}}
\caption{\label{fig:unnamed-chunk-43}Relative frequency of the incidence of malaria in female great tits in relation to control (N = 35) and Egg-removal (N = 30) treatment groups.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/mosaic_graph.png}}
\caption{\label{fig:unnamed-chunk-44}Example code chunk for producing a good mosaic plot}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-45-1.pdf}}
\caption{\label{fig:unnamed-chunk-45}Scatterplot of the association between bill length and depth among 151 Adelie penguins}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-46-1.pdf}}
\caption{\label{fig:unnamed-chunk-46}Serotonin levels in the central nervous system of desert locusts that were experimentally crowded for 0 (control), 1, and 2 hours. N = 10 per treatment group.}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/body_violin-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-47-1.pdf}}
\caption{\label{fig:unnamed-chunk-47}Violin plot showing the body mass (g) of male Adelie (N = 73), Chinstrap (N = 34), and Gentoo (N = 61) penguins.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-48-1.pdf}}
\caption{\label{fig:unnamed-chunk-48}Violin plot showing the body mass (g) of male Adelie (N = 73), Chinstrap (N = 34), and Gentoo (N = 61) penguins. Density plots are provided in the margin.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-49-1.pdf}}
\caption{\label{fig:unnamed-chunk-49}Boxplot showing the body mass (g) of male Adelie (N = 73), Chinstrap (N = 34), and Gentoo (N = 61) penguins. Density plots are provided in the margin. Boxes delimit the first and third quartiles, and the middle line depicts the median. Whiskers extend to values beyond the 1st (lower) and 3rd (upper) quartiles, up to a maximum of 1.5 x IQR, and individual black points are outlying values.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-50-1.pdf}}
\caption{\label{fig:unnamed-chunk-50}Violin plot showing the body mass (g) of male Adelie (N = 73), Chinstrap (N = 34), and Gentoo (N = 61) penguins. Boxplots are superimposed, with boxes delimiting the first and third quartiles, and middle line depicting the median. Whiskers extend to values beyond the 1st (lower) and 3rd (upper) quartiles, up to a maximum of 1.5 x IQR, and individual black points are outlying values.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-53-1.pdf}}
\caption{\label{fig:unnamed-chunk-53}Approximate sampling distribution of mean gene lengths from the human genome (10000 replicate samples of size 20).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-55-1.pdf}}
\caption{\label{fig:unnamed-chunk-55}Approximate sampling distribution of mean gene lengths from the human genome (10000 replicate samples of size 50).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/newsampfig-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-59-1.pdf}}
\caption{\label{fig:unnamed-chunk-59}Approximate null distribution for the damselfly study, with n = 20 trials, and probability of success = 0.5 in each trial. Data are from 100000 repetitions.}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/binomial_equation.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-65-1.pdf}}
\caption{\label{fig:unnamed-chunk-65}Probability of obtaining X successes out of 6 random trials, with probability of success = 1/6.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-66-1.pdf}}
\caption{\label{fig:unnamed-chunk-66}Probability of obtaining X successes out of 15 random trials, with probability of success = 1/6.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-69-1.pdf}}
\caption{\label{fig:unnamed-chunk-69}Relative frequency of cancer among women randomly assigned to control (n = 19942) and aspririn (n = 19934) treatment groups.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-74-1.pdf}}
\caption{\label{fig:unnamed-chunk-74}Mosaic plot of bird predation on killifish having different levels of trematode parasitism. A total of 50, 45, and 46 fish were in the uninfected, lightly infected, and highly infected groups.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-77-1.pdf}}
\caption{\label{fig:unnamed-chunk-77}Frequency distribution of body temperature (degrees Farenheit) for 25 randomly chosen healthy people.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-79-1.pdf}}
\caption{\label{fig:unnamed-chunk-79}The \emph{t} distribution for df = 24.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./more/confint_inline_code.png}}
\caption{\label{fig:unnamed-chunk-80}Example of inline markdown and R code for a confidence interval}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-84-1.pdf}}
\caption{\label{fig:unnamed-chunk-84}Histogram of the differences in antibody production rate before and after the testosterone treatment}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-85-1.pdf}}
\caption{\label{fig:unnamed-chunk-85}Paired plot of antibody production rate before and after the testosterone treatment}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-87-1.pdf}}
\caption{\label{fig:unnamed-chunk-87}Normal quantile plot of the differences in antibody production rate before and after the testosterone treatment (ln{[}mOD/min{]}) 10\^{}-3.}
\end{figure}
...
\label{tab:unnamed-chunk-88}Data summary
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-91-1.pdf}}
\caption{\label{fig:unnamed-chunk-91}Violin and boxplot of the heights of students with right (n = 106) and left (n = 48) dominant eyes. Boxes delimit the first to third quartiles, bold lines represent the group medians, and whiskers extend to 1.5 times the IQR. Points beyond whiskers are extreme observations.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-92-1.pdf}}
\caption{\label{fig:unnamed-chunk-92}Normal quantile plots of height for students with right (n = 106) or left (n = 48) dominant eyes.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-99-1.pdf}}
\caption{\label{fig:unnamed-chunk-99}Example of a normal quantile plot for a variable that is normally distributed.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-100-1.pdf}}
\caption{\label{fig:unnamed-chunk-100}The frequency distribution of the `biomass ratio' of 32 marine reserves.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-101-1.pdf}}
\caption{\label{fig:unnamed-chunk-101}Normal quantile plot of the `biomass ratio' of 32 marine reserves.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-102-1.pdf}}
\caption{\label{fig:unnamed-chunk-102}The frequency distribution of the `biomass ratio' of 32 marine reserves.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-103-1.pdf}}
\caption{\label{fig:unnamed-chunk-103}The frequency distribution of the `biomass ratio' of 32 marine reserves (log-transformed).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-104-1.pdf}}
\caption{\label{fig:unnamed-chunk-104}Figure: Normal quantile plot of the `biomass ratio' of 32 marine reserves (log-transformed).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-106-1.pdf}}
\caption{\label{fig:unnamed-chunk-106}Normal quantile plot of made-up biomass data.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-111-1.pdf}}
\caption{\label{fig:unnamed-chunk-111}Normal quantile plot of made-up biomass data, log-transformed.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-112-1.pdf}}
\caption{\label{fig:unnamed-chunk-112}Normal quantile plot of the proportion of seeds fertilized on 30 plants (left) and the corresponding normal quantile plot (right)}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-113-1.pdf}}
\caption{\label{fig:unnamed-chunk-113}Normal quantile plot of the proportion of seeds fertilized (logit transformed) on 30 plants}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/stripanova-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/stripanova2-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/stripanovatukey-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/unnamed-chunk-119-1.pdf}}
\caption{\label{fig:unnamed-chunk-119}The association between inbreeding coefficient and number of surviving wolf pups (n = 24).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/pupscatter-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/pupscatter2-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/trickplot-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/trickplot2-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigzero-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigone-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigtwo-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigthree-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigfour-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigfive-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigsix-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigseven-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{BIOL202_files/figure-latex/lsrfigeight-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/second_kable.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/toolbar.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/rosetta_error.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/rtools.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/no-function1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/no-function2.png}}

\section*{There is no package}\label{there-is-no-package}
\addcontentsline{toc}{section}{There is no package}

\pandocbounded{\includegraphics[keepaspectratio]{./more/no-pckg.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/CRAN-without-mirror1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/CRAN-without-mirror2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/parse.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/no-file1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/messy-output1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/messy-output2.png}}

\section*{Unused argument}\label{unused-argument}
\addcontentsline{toc}{section}{Unused argument}

\pandocbounded{\includegraphics[keepaspectratio]{./more/unused-arg1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/unused-arg2.png}}

\section*{Object not found}\label{object-not-found}
\addcontentsline{toc}{section}{Object not found}

\pandocbounded{\includegraphics[keepaspectratio]{./more/object-error1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/object-error2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/fig-cap-error1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/space_after_chunk.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{./more/unicode_error.png}}
