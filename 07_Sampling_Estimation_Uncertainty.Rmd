...
Let's first remind ourselves what the true mean gene length is in the entire population of genes. We'll assign the output to an object "true.mean.length", then show using the `kable` approach.
...
## The rule of thumb 95% confidence interval {#confint_rough}
...
**`r round(temp$Lower_95_CL, 3)` < $\mu$ < `r round(temp$Upper_95_CL, 3)`**  
