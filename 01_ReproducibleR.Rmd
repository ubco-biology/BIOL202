...
Whenever you wish to generate figures then export them as an image file, for example, you can write the file to this folder.  We'll learn about this later.

Writing and reading files to directories requires that we can tell R exactly where to find those directories.  That's where the handy package called `here` comes in. 
