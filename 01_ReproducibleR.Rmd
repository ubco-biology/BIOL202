...
1. Review the Biology department's [Procedures and Guidelines webpage](https://ubco-biology.github.io/Procedures-and-Guidelines/) description of how to [manage files and directories](https://ubco-biology.github.io/Procedures-and-Guidelines/file-and-data-management.html). 
...
First, let's install and load an R package called `here` that will help with file and directory management and navigation. 
...
This is a helpful [post](http://jenrichmond.rbind.io/post/how-to-use-the-here-package/) about the utility of the `here` package.
...
* Save your file again by clicking the save icon in the top left
