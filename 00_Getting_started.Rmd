...
[webpage](https://www.earthdatascience.org/courses/earth-analytics/document-your-science/intro-to-the-rmarkdown-format-and-knitr/). 

3. If you'd like additional introductory tutorials on R Markdown, see this one from RStudio: 

[demo](https://rmarkdown.rstudio.com/lesson-1.html), or this [one](https://rbasics.netlify.app/4-rmarkdown.html). 
