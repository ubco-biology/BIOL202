...
<div class="note">
**Note**
R Markdown is just one flavour of what's called a markup language.  What's a "markup" language you ask? You can find out in section 6 of the [Biology Procedures and Guidelines ](https://ubco-biology.github.io/Procedures-and-Guidelines/markdown-1.html). But do **NOT** install anything! You already have a markdown editor installed: RStudio! So please skip over section 6.2, which talks about installing markdown editors. 
</div>
