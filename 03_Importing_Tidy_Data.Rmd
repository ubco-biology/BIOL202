# Preparing andimporting Tidy Data {#data_import}
...
![Tidy data in Excel](./more/excel_tidy.png)
...
![View of files with rawdata folder](./more/files_pane_rawdata.png)
...
* Open up Excel or any other spreadsheet software and enter values in the spreadsheet cells exactly as shown in the #Tidy data in Excel above
...
<div class="note">
**New tool**
Here we introduce a new tool called a "pipe", actually coded as "`%>%`".  Pipes come from the `magrittr` package, which is already loaded as part of the `tidyverse` package. Please see this brief [introduction here](https://cfss.uchicago.edu/notes/pipes/)
</div>
...
One additional function that is useful during the overview stage is `head`. This function just gives you a view of the first 5 rows or so of the dataset:
