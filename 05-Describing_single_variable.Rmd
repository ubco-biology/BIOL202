...
## Describing a single numerical variable {#desc_numeric_var}
...
Let's create the table of descriptive statistics first, a tibble called "penguins.descriptors", and we'll describe what's going on after: 

```{r desc_penguins_3}
penguins.descriptors <- summarise(penguins, 
