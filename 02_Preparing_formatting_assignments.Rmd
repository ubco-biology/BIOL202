...
```{r, fig.cap = "Assignment markdown file header", echo = F, fig.width = 2.5, fig.height = 2.5}
...
```{r, fig.cap = "Code chunk header with message suppression", echo = F, fig.width = 3}
knitr::include_graphics("./more/install_package_header.png")
```
...
```{r, fig.cap = "Assignment markdown file header with figure caption option", echo = F, fig.width = 3}
knitr::include_graphics("./more/assign_header.png")
```
