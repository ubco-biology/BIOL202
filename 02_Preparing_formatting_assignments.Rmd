...
```{r import_students1, echo = F, message = F}
...
```{r import_students2, echo = F, message = F}
students <- read_csv("https://raw.githubusercontent.com/ubco-biology/BIOL202/main/data/students2.csv")
```
...
```{r bill_fig, echo = F, warning = F, fig.cap = "Figure 1: Histogram of bill depth among 151 Adelie penguins", fig.width = 4, fig.height = 4}
